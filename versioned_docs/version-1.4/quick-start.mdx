...
```bash
helmfile sync -f 'git::https://github.com/notaryproject/ratify.git@helmfile.yaml?ref=v1.4.3' 
```
...
### Step 3: Uninstall
```bash
helmfile destroy --skip-charts -f 'git::https://github.com/notaryproject/ratify.git@helmfile.yaml?ref=v1.4.3' 
```
