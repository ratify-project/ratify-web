...
```bash
helmfile sync -f git::https://github.com/notaryproject/ratify.git@helmfile.yaml
```
...
### Step 4: Uninstall
```bash
helmfile destroy --skip-charts -f git::https://github.com/notaryproject/ratify.git@helmfile.yaml
```
