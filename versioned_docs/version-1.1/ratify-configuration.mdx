...
To ensure predictable results, please install all CRs in a single namespace. This limitation is being tracked by issue [1061](https://github.com/ratify-project/ratify/issues/1061)
