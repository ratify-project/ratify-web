...
**Docker Build Attestations**: We now generate attestations, including provenance and a Software Bill of Materials (SBOM), for Ratify images. This improves transparency in the build process, ensuring better traceability and accountability of image contents.

**Image Signing**: Ratify images are now signed to ensure their integrity and authenticity. This helps defend against supply chain attacks by preventing tampered or untrusted images from being deployed in production environments.
