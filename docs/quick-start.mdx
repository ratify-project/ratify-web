...
```bash
helmfile sync -f 'git::https://github.com/ratify-project/ratify.git@helmfile.yaml.gotmpl?ref=v1'
```

> **NOTE** To use the latest development version of Ratify instead, refer to this [document](https://github.com/ratify-project/ratify/blob/main/CONTRIBUTING.md#deploy-using-dev-helmfile)
...
### Step 3: Uninstall
```bash
helmfile destroy --skip-charts -f 'git::https://github.com/ratify-project/ratify.git@helmfile.yaml.gotmpl?ref=v1'
```
