...
const AsciinemaPlayer = () => {
  useEffect(() => {
    ...
    script.src = 'https://asciinema.org/a/bJMOlPe5F4mFLY0Rl6fiJSOp3.js';
    script.id = 'asciicast-bJMOlPe5F4mFLY0Rl6fiJSOp3';
    script.async = true;
  ...
  return <div id="asciicast-bJMOlPe5F4mFLY0Rl6fiJSOp3"></div>;
};
