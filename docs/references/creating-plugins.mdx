...
Ratify supports plugins for [stores](/docs/Developer/store.mdx) and [verifiers](/docs/Developer/verifier.mdx) so that users can add capabilities that aren't included in the core application. This document is a guide on creating your own plugins.
