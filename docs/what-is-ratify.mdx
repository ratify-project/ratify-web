...
The Ratify release process is defined in [RELEASES.md](https://github.com/deislabs/ratify/blob/main/RELEASES.md).

## Licensing

This project is released under the [Apache-2.0 License](https://github.com/deislabs/ratify/blob/main/LICENSE).
